...
export function ManualSetupSQL() {
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1">
          <h4 className="font-semibold text-blue-900 mb-1">Manual Database Setup</h4>
      ...
      <ol className="text-xs text-blue-800 space-y-2 ml-4 list-decimal">
        <li className="pl-1">
          Click the "Copy SQL" button above to copy the complete setup script
        </li>
        <li className="pl-1">
          Go to your{' '}
          <a
            href="https://supabase.com/dashboard/project/sptjgtzgpgsgrccgcrpv/sql/new"
            target="_blank"
        ...
        <li className="pl-1">
          Paste the SQL and click <strong>Run</strong> (or press Cmd/Ctrl + Enter)
        </li>
        <li className="pl-1">
          Wait for all statements to complete (should take 10-15 seconds)
        </li>
        <li className="pl-1">
          Come back here and refresh the page - you'll be able to create your admin user!
        </li>
      </ol>

      <div className="bg-blue-100 rounded px-3 py-2">
        <p className="text-xs text-blue-900">
          <strong>Tip:</strong> If you see any "already exists" errors, that's normal - it means some tables
          were already created. Just make sure the script completes successfully.
        </p>
      </div>
    </div>
  );
