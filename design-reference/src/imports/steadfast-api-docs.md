...
Get Policestations (Recently Added)
...
consignment_id or invoice or tracking_code

Required. Numeric or string

Consignment id or user defined invoice id or tracking code of the consignment of the requesting consignment.
